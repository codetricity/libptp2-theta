...
// To avoid clashes with definitions in /usr/include/endian.h.
// See src/cpp/brainos/hal/ricoh360/tests/Ricoh360Tests.cpp Endian tests.
#define htobe16_ptpcamera(x) htons(x)
#define htobe32_ptpcamera(x) htonl(x)
#define be16toh_ptpcamera(x) ntohs(x)
#define be32toh_ptpcamera(x) ntohl(x)
...
// To avoid clashes with definitions in /usr/include/endian.h.
// See src/cpp/brainos/hal/ricoh360/tests/Ricoh360Tests.cpp Endian tests.
#define htole16_ptpcamera(x)      swap16(x)
#define htole32_ptpcamera(x)      swap32(x)
#define le16toh_ptpcamera(x)      swap16(x)
#define le32toh_ptpcamera(x)      swap32(x)

#define htobe64_ptpcamera(x)      (x)
#define be64toh_ptpcamera(x)      (x)
...
// To avoid clashes with definitions in /usr/include/endian.h.
// See src/cpp/brainos/hal/ricoh360/tests/Ricoh360Tests.cpp Endian tests.
#define htole16_ptpcamera(x)      (x)
#define htole32_ptpcamera(x)      (x)
#define htole64_ptpcamera(x)      (x)
#define le16toh_ptpcamera(x)      (x)
#define le32toh_ptpcamera(x)      (x)
#define le64toh_ptpcamera(x)      (x)
...
// To avoid clashes with definitions in /usr/include/endian.h.
// See src/cpp/brainos/hal/ricoh360/tests/Ricoh360Tests.cpp Endian tests.
#define htobe64_ptpcamera(x)      swap64(x)
#define be64toh_ptpcamera(x)      swap64(x)
